...
class CRNN(nn.Module):
    ...
    def forward(self, x):
        conv = self.cnn(x)  # (B, 512, 2, W/4)
        b, c, h, w = conv.size()
        conv = conv.view(b, c * h, w)  # (B, 1024, W/4)
        conv = conv.permute(0, 2, 1)  # (B, W/4, 1024)
        
        rnn_out, _ = self.rnn(conv)  # (B, W/4, 512)
...
def train():
    ...
    os.makedirs('/home/xufei/tibet_acent/checkpoints_v4', exist_ok=True)
    ...
    for epoch in range(100):
        ...
        if char_acc > best_char_acc:
            ...
            }, '/home/xufei/tibet_acent/checkpoints_v4/best.pth')
        ...
        if (epoch + 1) % 10 == 0:
            ...
            }, f'/home/xufei/tibet_acent/checkpoints_v4/epoch_{epoch+1}.pth')
    
    with open('/home/xufei/tibet_acent/checkpoints_v4/history.json', 'w') as f:
