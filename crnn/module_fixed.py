...
def _load_charset(charset: str) -> str:
    """If charset is a file path, read its contents and join all characters."""
...
class SceneTextDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        self.charset_train = _load_charset(charset_train)
        self.charset_test = _load_charset(charset_test)
    ...
    def train_dataset(self):
        if self._train_dataset is None:
            ...
            root = (Path(self.root_dir) / 'train').resolve()
    ...
    def val_dataset(self):
        if self._val_dataset is None:
            ...
            root = (Path(self.root_dir) / 'val').resolve()
